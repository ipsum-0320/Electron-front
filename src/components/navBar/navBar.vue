    ...
    <div class="nav-options">
      <div class="nav-option nav-option-pet">
        <div class="nav-pet-option">
          ...
          <div class="icon-font">
            Product<img src="@/assets/image/svg/navbar/more.svg" alt="" class="icon-more">
          </div>
        </div>
