<template>
  <div class="chat">
    <chat-list :list-width="offsetX" @chatTo="chatTo(chatToUsername)"></chat-list>
    ...
    <chat-window :window-width="offsetX" :chatToUsername="chatToUsername"></chat-window>
  </div>
</template>
