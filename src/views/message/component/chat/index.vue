<template>
  <div class="chat">
    <chat-list :list-width="offsetX"></chat-list>
    <div class="divider" @mousedown="move" :style="{ left: (277 + offsetX) + 'px' }">
<!--   为什么动态 style 不能使用模板字符串？   -->
    ...
    <chat-window :window-width="offsetX"></chat-window>
  </div>
</template>
